...
const StoreAddedSuccessfully = ({ isOpen, setIsOpen, title, description }) => {
    ...
    >
      <div className="bg-white rounded-[12px] p-8 shadow-lg w-[515px] h-[356px]">
        ...
        <div className="flex flex-col mt-8 gap-2 text-center justify-center items-center">
          ...
          <p className="text-[#838383] text-[16px] font-[400]">{description}</p>
        </div>
      </div>
    </Modal>
  );
...
export default StoreAddedSuccessfully;

...
const RiderArivedModal = ({ isOpen, setIsOpen }) => {
  return (
    <Modal
      isOpen={isOpen}
    ...
    >
      <div className="bg-white rounded-[12px] p-8 shadow-lg w-[515px] h-[356px]">
        ...
        <div className="flex flex-col mt-8 gap-2 text-center justify-center items-center">
         ...
         [Rider Name] has reached your store to collect the order. Please ensure the package is ready for handover.
          </p>
          <Button text={"Acknowledge & Confirm Pickup"} customClass={"w-[428px] mt-4"} />
        </div>
      </div>
    </Modal>
  );
